...
| 9 | (2026-07-19) Runtime lineage SSOT | **Execution ledger** projected from actual Rust query events | Observation records remain separate from wall-clock timing and never alter behavior. The current ledger uses query and query-group identities. |
