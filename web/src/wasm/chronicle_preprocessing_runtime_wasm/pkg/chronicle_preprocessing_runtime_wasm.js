/* @ts-self-types="./chronicle_preprocessing_runtime_wasm.d.ts" */

export class PreparedReviewWorkspace {
    static __wrap(ptr) {
        const obj = Object.create(PreparedReviewWorkspace.prototype);
        obj.__wbg_ptr = ptr;
        PreparedReviewWorkspaceFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PreparedReviewWorkspaceFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_preparedreviewworkspace_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} selected_base
    ...
    required_base_kind() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.preparedreviewworkspace_required_base_kind(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export class RuntimeHandle {
    static __wrap(ptr) {
        const obj = Object.create(RuntimeHandle.prototype);
        obj.__wbg_ptr = ptr;
        RuntimeHandleFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        RuntimeHandleFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_runtimehandle_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get artifact_count() {
        const ret = wasm.runtimehandle_artifact_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} index
    ...
    artifact_metadata_json(index) {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.runtimehandle_artifact_metadata_json(retptr, this.__wbg_ptr, index);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
    ...
    manifest_json() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.runtimehandle_manifest_json(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    take_artifact_bytes(index) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.runtimehandle_take_artifact_bytes(retptr, this.__wbg_ptr, index);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
if (Symbol.dispose) RuntimeHandle.prototype[Symbol.dispose] = RuntimeHandle.prototype.free;
...
export class RuntimeSupportFiles {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        RuntimeSupportFilesFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_runtimesupportfiles_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.runtimesupportfiles_new();
        this.__wbg_ptr = ret;
        RuntimeSupportFilesFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} role
...
export function build_environment_digest() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.build_environment_digest(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
 ...
 * @returns {string}
 */
export function evaluate_workspace_requirements(request_json, csv_bytes, support_files) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @param {string} request_json
 * @param {Uint8Array} csv_bytes
 * @param {Uint8Array} review_base_bytes
 * @param {RuntimeSupportFiles} support_files
 * @returns {RuntimeHandle}
 */
 ...
 * @param {Uint8Array} csv_bytes
 * @param {Uint8Array} review_base_bytes
 * @param {Uint8Array} reconstruction_base_bytes
 * @param {RuntimeSupportFiles} support_files
 * @returns {RuntimeHandle}
 */
...
export function implementation_build_digest() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.implementation_build_digest(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
 ...
 * @returns {string}
 */
export function inspect_raw_file_v1(csv_bytes, file_name, size_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
 ...
 * @param {string} request_json
 * @param {number} input_size_bytes
 * @param {Uint8Array} review_probe
 * @param {Uint8Array} reconstruction_probe
 * @param {RuntimeSupportFiles} support_files
 * @returns {PreparedReviewWorkspace}
 */
export function prepare_persisted_workspace_review(request_json, input_size_bytes, review_probe, reconstruction_probe, support_files) {
    try {
        ...
        return PreparedReviewWorkspace.__wrap(r0);
    } finally {
        wasm.__wbindgen_add_to_stack_pointer(16);
    }
}
...
export function review_base_probe_spec_json() {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.review_base_probe_spec_json(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
 ...
 * @returns {string}
 */
export function runtime_identity_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.runtime_identity_json(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./chronicle_preprocessing_runtime_wasm_bg.js": import0,
    };
}
...
const RuntimeSupportFilesFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_runtimesupportfiles_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chronicle_preprocessing_runtime_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
