...
## 1. Screen-gated valid-usage credit (the Layer-2 paradigm)
...
Under the screen-gated credit paradigm on personal devices this relabel is OFF (the shell counts as a
