...
class AppCodebookColumn(StrEnum):
    ...
    PLAY_STORE_GENRE_ID = "bcm_play_store_genreId"
    PLAY_STORE_GENRE = "bcm_play_store_genre"
    PLAY_STORE_BROAD_APP_CATEGORY = "bcm_play_store_broad_app_category"
    PLAY_STORE_DEVELOPER = "bcm_play_store_developer"
    PLAY_STORE_FREE = "bcm_play_store_free"
    PLAY_STORE_RATING = "bcm_play_store_rating"
    PLAY_STORE_DOWNLOADS = "bcm_play_store_downloads"
    USC_BROAD_APP_CATEGORY = "usc_broad_app_category"
    USC_GENRE_ID = "usc_genreId"
    ...
    BABYEMU_GENRE_ID_SCRAPED = "babyemu_genreId_scraped"
    BABYEMU_GENRE_ID_MANUAL = "babyemu_genreId_manual"
...
class Column(StrEnum):
    ...
    SCREEN_USAGE_APPS_FORCING_SCREEN_OPEN_LABEL = "screen_usage_apps_forcing_screen_open_label"
    ...
    CODEBOOK_APPLICATION_LABEL = "codebook_application_label"
    PLAY_STORE_GENRE_ID = "bcm_play_store_genreId"
    PLAY_STORE_GENRE = "bcm_play_store_genre"
    PLAY_STORE_BROAD_APP_CATEGORY = "bcm_play_store_broad_app_category"
    PLAY_STORE_DEVELOPER = "bcm_play_store_developer"
    ...
    ANY_APP_USAGE_TIME_GAP_HOURS = "any_app_usage_time_gap_hours"
    ANY_APP_USAGE_FLAGS = "any_app_usage_flags"

    # Additional validated columns from preprocessing modules
