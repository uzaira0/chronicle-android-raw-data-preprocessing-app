...
mod persistence {
        ...
        C: Configuration,
    {
            ...
            M: de::MapAccess<'de>,
        {
            ...
            // An owned key lets formats such as MessagePack deserialize from a
            // streaming reader. `&str` only works when the complete input is
            // already available as one borrowable byte slice.
