 ...
 * @returns {string}
 */
export function query_registered(index, query_id) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        wasm.query_registered(retptr, ptr0, len0, ptr1, len1);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./chronicle_semantic_index_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chronicle_semantic_index_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
