"""
GUI interface for Chronicle Android Raw Data Preprocessing.

This module provides the PyQt6-based graphical user interface.
"""
...
from chronicle_preprocessing_app.config.constants import LOG_FORMAT
