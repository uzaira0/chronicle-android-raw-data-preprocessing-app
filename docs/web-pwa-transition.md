...
- Local raw Chronicle CSV ingestion in the browser
- Local app-usage preprocessing CSV output
...
5. Raw Chronicle CSV files are parsed client-side and converted into local preprocessed CSV output.
...
2. Port screen-usage derivation and codebook enrichment into the browser path.
3. Port additional Rust-backed preprocessing stages into WASM.
4. Support multi-file batch download packaging and richer parity verification.
